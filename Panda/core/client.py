...
class PandaUserBotClient(TelegramClient):
    def ilhammansiz_cmd(
        self: TelegramClient,
...
PandaUserBotClient.fast_download_file = download_file
PandaUserBotClient.fast_upload_file = upload_file
PandaUserBotClient.reload = restart_script
PandaUserBotClient.check_testcases = checking
