...
@pandaub.ilhammansiz_cmd(
    ...
    info={
        ...
        "usage": [
            "{tr}setwelcome <welcome message>",
            "reply {tr}setwelcome to text message or supported media with text as media caption",
        ],
        "examples": "{tr}setwelcome Hi {mention}, Welcome to {title} chat",
    },
)
