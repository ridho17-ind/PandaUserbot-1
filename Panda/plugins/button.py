...
@pandaub.ilhammansiz_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [pandauserbot]<buttonurl:https://t.me/TEAMSquadUserbotSupport> [support]<buttonurl:https://t.me/TEAMSquadUserbotSupport>",
    },
)
async def _(event):
