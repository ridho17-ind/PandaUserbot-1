...
async def panda_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def panda_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
