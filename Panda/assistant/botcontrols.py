...
async def bot_broadcast(event):
    ...
    if not replied:
        return await event.reply("🐼 Balas ke pesan untuk melakukan broadcast 🐼 !")
    start_ = datetime.now()
...
async def ban_starters(event):
    "Untuk mendapatkan daftar pengguna yang dilarang di bot."
